...
theme.addEventListener("click", ()=>{
    if(ctheme){
        theme.src = "NewIcons/sun.png";
        canvasBoard.style.filter = "invert(100%)";
        redColor.style.backgroundColor = "cyan";
        blueColor.style.backgroundColor = "yellow";
        greenColor.style.backgroundColor = "lightpink"
    }
    
    else{
        theme.src = "NewIcons/moon.png";
        canvasBoard.style.filter = "invert(0%)";
